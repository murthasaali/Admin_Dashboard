    ...
    >
        ...
        <div className="max-w-[70%]  w-[70%] p-px bg-gradient-to-b h-full  bg-opacity-10 flex-col flex gap-3 ">
          <nav className="w-full flex justify-start gap-2 items-center text-xs">
            ...
            <div className="p-px h-ful flex gap-2">
              ...
              <img
                src="https://avatars.mds.yandex.net/i?id=628c908972b034f7236d7d6c63b12119de955a63-9569150-images-thumbs&ref=rim&n=33&w=375&h=375"
                className="w-10 h-10 rounded-full"
              />
              <div className="w-fit h-fit flex flex-col justify-between">
                <h1 className="text-sm font-thin text-stone-200">
                  Mushfiqur Rahman
                </h1>
                <h1 className="text-xs font-thin text-stone-50 text-opacity-35">
                  hello@gmail.com
                </h1>
              </div>
            </div>
          </nav>
          <h1 className="text-[40px] text-white  font-thin w-full relative">
            {" "}
            <button className="text-xs flex justify-center items-center  absolute right-0 bottom-0 gap-2">
              Show more <FaSearch />
            </button>
          </h1>
          {/* nft cards */}
          <div className="w-full h-fit  flex justify-between gap-3">
            <div
              className="w-[50%] h-52 bg-stone-50 rounded-3xl flex justify-start items-end p-4"
              style={{
                backgroundImage:
                  "url('https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/f04a2b153523503.6331a40cd438d.png')",
              ...
              <div className="w-[50%] h-[60%] backdrop-blur-sm rounded-3xl bg-stone-900 bg-opacity-30">
                <div className="flex p-3 justify-between">
                  <div className="flex flex-col gap-2 justify-center items-center">
                    ...
                    <h1 className="text-[10px] text-white font-thin">
                      {" "}
                      remining
                    </h1>
                  </div>
                ...
                <div className="w-full h-12  p-3">
                  <button className="bg-customColor  w-full h-full rounded-2xl opacity-70 text-xs font-thin text-white">
                    place a bid
                  </button>
                </div>
              </div>
          ...
          <div className="text-[30px] text-white  font-thin w-full relative flex gap-2">
            ...
            <button
              className="text-xs flex justify-center items-center  absolute right-0 bottom-0 gap-2"
              onClick={() => nav("/orders")}
            >
              Show more{" "}
            </button>
      ...
      <div className="max-w-[20%] rounded-3xl w-[35%] p-px bg-gradient-to-b h-full bg-opacity-50 from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 ">
        <div className="rounded-[calc(1.5rem-1px)]  bg-white h-full dark:bg-gray-900 flex flex-col p-3 gap-3">
          <Activities />
          <TopBuyersList />
          <button className="text-iconcolor text-xs font-thin">
            www.growhance.com
          </button>
        </div>
      </div>

    ...
    >
      ...
      {/* second parent */}
     {
      ...
      <nav className="w-full flex justify-start gap-2 items-center text-xs">
        <div className="p-px bg-gradient-to-b from-customColor2  opacity-70 to-pink-300 dark:from-from-blue-300 dark:to-from-blue-300  rounded-full">
          <div className="w-[300px] h-10 bg-gradient-to-b from-customColor2 rounded-full to-customColor  flex justify-center items-center text-xl p-4 gap-2 shadow-md  ">
        ...
        <div className="p-px bg-gradient-to-b from-customColor2 opacity-70 to-pink-300 dark:from-from-blue-300 dark:to-from-blue-300  rounded-full">
          <div className="w-fit h-10 bg-gradient-to-b font-bold text-white from-customColor2 rounded-full to-customColor  flex justify-center items-center text-xl p-4 gap-2 shadow-md  ">
            <CiSearch className="text-white" />
            32,ETH
        ...
        <div className="p-px bg-gradient-to-b from-customColor2 opacity-70 to-pink-300 dark:from-from-blue-300 dark:to-from-blue-300  rounded-full">
          <div className="w-fit h-10 bg-gradient-to-b font-normal text-white from-customColor2 rounded-full to-customColor  flex justify-center items-center text-xl p-4 gap-2 shadow-md  ">
        Create
          </div>
        </div>
        <div className="p-px bg-gradient-to-b from-customColor2 opacity-70 to-pink-300 dark:from-from-blue-300 dark:to-from-blue-300  rounded-full">
          <div className="w-fit h-10 bg-gradient-to-b font-thin text-white from-customColor2 rounded-full to-customColor  flex justify-center items-center  p-4 gap-2 shadow-md  ">
        connect wallet
          </div>
        </div>
